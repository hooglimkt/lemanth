                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page"><a href="especialidades.php?pertence=<?php echo $_GET['pertence']?>" class="text-muted">Integrantes</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<div class="col-md-12">	   
   ...
   <div class="form-group row">
	...
	<textarea name="meta_description" class="form-control" id="" cols="30" rows="3"></textarea> 
                                    ...
                                    <input type="hidden" name="pertence_ao" value="<?php echo $_GET['pertence']?>">
                                </form>
                            </div>
                        </div>
                    </div>
